export declare namespace Templates {
    ...
    const openIssuesItem = "* #<%= issue.number %> <%= issueLink %> by <%= userLink%>";
    const closedIssuesTitle = "## CLOSED ISSUES";
    const closedIssuesItem = "* #<%= issue.number %> <%= issueLink %> by <%= userLink%>";
    ...
    const likedIssuesItem = "* #<%= issue.number %> <%= issueLink %> by <%= userLink%>, received <%= reactions %>.";
    const hotIssuesTitle = "\n    <% if (hotIssues.length > 1) { %>\n      ## TOP <%= hotIssues.length %> HOT ISSUES\n    <% } else { %>\n      ## MOST HOT ISSUE\n    <% } %>\n  ";
    const hotIssuesItem = "* #<%= issue.number %> <%= issueLink %> by <%= userLink%>, received <%= issue.comments %> comments.";
    ...
    const openPullRequestsItem = "* #<%= pullRequest.number %> <%= pullRequestLink %> by <%= userLink%>";
    ...
    const updatedPullRequestsItem = "* #<%= pullRequest.number %> <%= pullRequestLink %> by <%= userLink%>";
    ...
    const mergedPullRequestsItem = "* #<%= pullRequest.number %> <%= pullRequestLink %> by <%= userLink%>";
    ...
    const commitsItem = "* <%= commitLink %> by <%= userLink%>";
    ...
    const contributorsItem = "* <%= userLink%>";
    ...
    const releasesItem = "* [<%= releaseName %>](<%= release.html_url %>)";
}
